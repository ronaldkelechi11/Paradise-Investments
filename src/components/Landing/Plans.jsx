    ...
    return (
        <div id="plans" className="w-screen bg-white flex flex-col gap-3 p-2 md:p-5">
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 md:grid-rows-2 content-center gap-3 pt-5 pb-5">
                <PlanItem name={"Basic Package"} percentage={"20%"} minimum={"50"} maximum={"499"}
                    duration={"24"} refferal={"5%"} />

                <PlanItem name={"Regular Package"} percentage={"50%"} minimum={"500"} maximum={"999"} duration={"48"} refferal={"5%"} />

                <PlanItem name={"Premium Package"} percentage={"80%"} minimum={"1,000"} maximum={"9,999"} duration={"72"} refferal={"10%"} />

                <PlanItem name={"VIP Package"} percentage={"100%"} minimum={"10,000"} maximum={"20,000"} duration={"96"} refferal={"10%"} />
            </div>
        </div>
    )
}

...
const About = () => {
    return (
        <div id='about' className='w-screen  bg-white p-2 md:p-5'>
            <div className="text-black font-extrabold font-poppins uppercase text-center text-3xl md:text-6xl">About Us</div>
            ...
            <div className="w-full h-full flex flex-col md:items-center md:flex-row">
                <div className="h-[50%] w-full md:w-[50%] md:h-full flex justify-center items-center">
                    <p className="text-primary text-[15rem] font-billabong">Pi</p>
                </div>
                <div className="h-auto w-full md:w-[50%] md:h-full"><strong className="text-primary">Paradise Investments</strong> is a platform that is actively analyzing market trends and develops business
                    ...
                    We have carefully analyzed the international financial market for years and take into account all the

...
function SentMessage({ message }) {
    return (
        <div className="bg-green-400 max-w-[80%] self-end p-2 text-white font-poppins rounded-[10px_10px_0px_10px] capitalize">
            {message.text}
        </div>
    )
}
...
function ReceivedMessage({ message }) {
    return (
        <div className="bg-primary max-w-[80%] self-start p-2 text-white font-poppins rounded-[10px_10px_10px_0px] capitalize">
            {message.text}
        </div>
    )
}
